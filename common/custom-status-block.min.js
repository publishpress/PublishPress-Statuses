...
setInterval(function () {
  ...
  if (currentWorkflowSelection == 'next') {
    if ('publish' == ppObjEdit.nextStatus || 'future' == ppObjEdit.nextStatus) {
      ...
      ppObjEdit.publish = ('future' == ppObjEdit.nextStatus) ? ppcs__('Schedule') : ppcs__('Publish');
    } else {
  ...
  if (currentWorkflowSelection == 'max') {
    if ('publish' == ppObjEdit.maxStatus || 'future' == ppObjEdit.maxStatus) {
      ...
      ppObjEdit.publish = ('future' == ppObjEdit.maxStatus) ? ppcs__('Schedule') : ppcs__('Publish');
    } else {
  ...
  if ($('div.editor-post-publish-panel__prepublish').length) {
    ...
    switch (ppObjEdit.maxStatus) {
      case 'publish':
        $('div.pp-statuses-workflow div.components-radio-control__option:last label').html(ppcs__('Publish'));
        break;

      case 'future':
        $('div.pp-statuses-workflow div.components-radio-control__option:last label').html(ppcs__('Schedule'));
        break;

      default:
        $('div.pp-statuses-workflow div.components-radio-control__option:last label').html(ppcs__('Advance to Max Status'));
        break;
    }
...
var PPCustomPostStatusInfo = function PPCustomPostStatusInfo(_ref) {
  ...
  return React.createElement(
    ...
    React.createElement("div", {className: "publishpress-extended-post-status-published"}, 
      ...
      React.createElement("span", null, ppcs__('This post is currently published.'))
    ),
    React.createElement("div", {className: "publishpress-extended-post-status-scheduled"}, 
      ...
      React.createElement("span", null, ppcs__('This post is scheduled for publication.'))
    )
  );
};
...
var PPWorkflowAction = function PPWorkflowAction(_ref) {
  ...
  var maxStatusCaption = ('publish' == ppObjEdit.maxStatus) ? ppcs__('Publish') : ppcs__('Advance to Max Status');

  var radioOptions = [
    { label: ppcs__('Set Selected Status'), value: 'specified' },
    { label: ppcs__('Keep Current Status'), value: 'current' },
    { label: ppcs__('Advance to Next Status'), value: 'next' },
  ...
  }, React.createElement("h3", null, ppcs__('Publication Workflow', 'publishpress-statuses')), React.createElement(RadioControl, {
    label: "",
