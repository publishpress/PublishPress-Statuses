 ...
 * v 2.1a.k / 2023-04-04
 * 
 * Modified by Kevin Behrens to use entire html ID in hierarchy array.
			...
			$(items).each(function() {
				...
				if (res) {
					str.push(
						...
						(pid ? pid[0] : o.rootID));	// kevinB modification: use entire html ID
				}
			});
		...
		toHierarchy: function(options) {
			...
			function _recursiveItems(item) {
				...
				if (id) {
					currentItem = {
						//"id": id[2]
						"id": id[0] // kevinB modification: use entire html ID
					};
