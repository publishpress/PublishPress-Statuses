...
class StatusHandler {
    ...
    public static function handleEditCustomStatus()
    {
        ...
        $name = sanitize_key($_GET['name']);
        $status_obj = $existing_status; //get_post_status_object($name);
        ...
        //if (empty($status_obj->_builtin)) {
            ...
            */
            ...
            if (!empty($_REQUEST['return_module'])) {
                ...
                //$redirect_url = admin_url("admin.php?message=status-updated&page=publishpress-statuses");
            }
    ...
    public static function updateCustomStatus($name, $args = [])
    {
        ...
        */
        ...
        elseif (isset($args['position'])) {
            ...
            update_option('psppno_status_' . $name . '_position', $args['position']);
        }
        */
    ...
    public static function handleAjaxUpdateStatusPositions()
    {
        ...
        if (!empty($_REQUEST['status_hierarchy'])) {
            ...
            //error_log(serialize($status_parents));
            ...
            foreach ($status_parents as $status_name => $edited_status_parent) {
                ...
                //error_log("updating $status_name: parent $edited_status_parent");
    ...
    public static function settings_validate($new_options)
    {
        ...
        $new_options['post_types'] = self::clean_post_type_options(
            $new_options['post_types'],
            'pp_custom_statuses'
            //\PublishPress_Statuses::instance()->post_type_support_slug
        );
    ...
    public static function settings_validate_and_save()
    {
        ...
        //$publishpress->update_all_module_options($module->name, $new_options);
